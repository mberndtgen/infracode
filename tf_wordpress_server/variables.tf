...
variable "ami_map" {
  ...
  default     = {
    ...
    # hvm-ebs-ssd, see https://cloud-images.ubuntu.com/locator/ec2/
    ubuntu16-us-east-1      = "ami-e3c3b8f4"
    ubuntu16-us-west-1      = "ami-204e0040"
    ubuntu16-us-west-2      = "ami-a9d276c9"
    ubuntu16-eu-central-1   = "ami-cbb844a4"
    ubuntu16-eu-west-1      = "ami-844e0bf7"
    ubuntu16-ap-southeast-1 = "ami-a1288ec2"
    ubuntu16-ap-southeast-2 = "ami-4d3b062e"
    ubuntu16-ap-northeast-1 = "ami-0567c164"
    ubuntu16-ap-northeast-2 = "-1"
    ubuntu16-sa-east-1      = "ami-e93da085"
...
variable "tag_description" {
  ...
  default     = "Created using Terraform (tf_bare_server)"
}
variable "username" {
...
variable "user_email" {
  description = "first user's e-mail address"
  default     = "admin@domain.tld"
}
variable "user_firstname" {
  description = "first user's first name"
  default     = "Admin"
}
variable "user_lastname" {
  description = "first user's last name"
  default     = "User"
}
